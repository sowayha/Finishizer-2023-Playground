 ...
 */
define('UPDATE_URL', 'https://www.finishizer.net/finishizer_updates/index.php');

/**
 * Get latest version info
 */
define('UPDATE_INFO_URL', 'https://www.finishizer.net/finishizer_updates/update_info.php');
