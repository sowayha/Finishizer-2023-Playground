...
class Migration_Version_230 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(VIEWPATH . 'themes/finishizer/scripts.php')) {
            @unlink(VIEWPATH . 'themes/finishizer/scripts.php');
        }
        ...
        foreach ($themes as $theme) {
            if ($theme != 'finishizer') {
                if (!file_exists(VIEWPATH . 'themes/' . $theme . '/functions.php')) {
                    copy(VIEWPATH . 'themes/finishizer/functions.php', VIEWPATH . 'themes/' . $theme . '/functions.php');
                }
            }
        }
